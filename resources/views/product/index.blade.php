...
<div class="row">
    ...
    @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-25">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-8 productSearch">
                            {!! Form::label('type', __('product.brand') ) !!}
                        ...
                        <div class="col-md-3">
                             <label>&nbsp;</label>
                             <button type="submit" class="btn btn-primary pull-right" id="submit_search_button">@lang( 'messages.search' )</button>
                        </div>
                    </div>
                </div>
            </div>
